...
public class NearVision extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        else
        {
            ...
            directions.setText("If you are unable to read whole paragraph then you should consult an Eye Specialist");
